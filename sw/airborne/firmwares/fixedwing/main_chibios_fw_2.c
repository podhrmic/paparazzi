...
#include "firmwares/fixedwing/main_chibios_fw_2.h"
...
// Dummy
static uint8_t  mcu1_status = 0;
static uint8_t ahrs_timeout_counter = 0;
...
/**
 * Fbw event = set actuators from commands
 */
...
#else
#error "what the hell is the auto mode?"
...
/*
 * Some dummy for vsupply and current
 */
