...
void xgear_periodic(void)
{
  ...
  // YawPitchRoll [deg]
  memcpy(&xgear.msg_buf[idx], &ins_vn.attitude, 3*sizeof(float));
  idx += 3*sizeof(float);

  // AngularRate
  memcpy(&xgear.msg_buf[idx], &ins_vn.gyro, 3*sizeof(float));
  idx += 3*sizeof(float);
  ...
  // Accel
  memcpy(&xgear.msg_buf[idx], &ins_vn.accel, 3*sizeof(float));
  idx += 3*sizeof(float);
  ...
  //posU, float[3]
  memcpy(&xgear.msg_buf[idx], &ins_vn.pos_u, 3*sizeof(float));
  idx += 3*sizeof(float);

  //velU, float
  memcpy(&xgear.msg_buf[idx], &ins_vn.vel_u, sizeof(float));
  idx += sizeof(float);
  ...
  //YprU, float[3]
  memcpy(&xgear.msg_buf[idx], &ins_vn.ypr_u, 3*sizeof(float));
  idx += 3*sizeof(float);
