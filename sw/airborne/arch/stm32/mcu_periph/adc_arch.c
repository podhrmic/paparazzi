...
void adc_init( void ) {
  ...
  */
  ...
  volatile uint32_t* tmp_channels_1[]={&ADC_JDR1(ADC1),
                                       &ADC_JDR2(ADC1),
                                       &ADC_JDR3(ADC1),
                                       &ADC_JDR4(ADC1)};
  ...
  volatile uint32_t* tmp_channels_2[]={&ADC_JDR1(ADC2),
                                       &ADC_JDR2(ADC2),
                                       &ADC_JDR3(ADC2),
                                       &ADC_JDR4(ADC2)};
#ifdef USE_AD2_1
  ...
  for(channel = 0; channel < NB_ADC3_CHANNELS; channel++) {
    adc3_buffers[channel] = NULL;
  }
  volatile uint32_t* tmp_channels_3[]={&ADC_JDR1(ADC3),
                                       &ADC_JDR2(ADC3),
                                       &ADC_JDR3(ADC3),
                                       &ADC_JDR4(ADC3)};
#ifdef USE_AD3_1
  ...
  adc_channel_map[0] = BOARD_ADC1_CHANNEL_2;
  ...
  adc_channel_map[0] = BOARD_ADC1_CHANNEL_3;
#elif defined(USE_AD1_3)
  adc_channel_map[2] = USE_AD1_3;
#else
  adc_channel_map[2] = 0xFF;
#endif
#if defined(BOARD_ADC_CHANNEL_4)
  adc_channel_map[3] = BOARD_ADC_CHANNEL_4;
#elif defined(BOARD_ADC1_CHANNEL_4)
  adc_channel_map[0] = BOARD_ADC1_CHANNEL_4;
