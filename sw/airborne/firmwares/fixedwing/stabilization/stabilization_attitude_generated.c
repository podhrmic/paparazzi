 ...
 *
 * Auto generated Fixed wing horizontal control.
 *
 */
...
/// Simulink file:
#include "modules/simulink/roll_loop/roll_loop.h"
...
void h_ctl_init(void)
{
  ...
  /// HERE WE WILL CALL THE SIMULINK ROUTINE
  roll_loop_initialize();
}
...
inline static void h_ctl_roll_loop(void)
{
  /// THIS WILL BE REPLACED WITH A CALL TO SIMULINK ROUTINE
  /*
  ...
  */
  ...
  // update the inputs
  roll_loop_U.roll_setpoint = h_ctl_roll_setpoint;
  roll_loop_U.roll = stateGetNedToBodyEulers_f()->phi;
  roll_loop_U.roll_rate = stateGetBodyRates_f()->p;

  // update the gains
  roll_loop_P.P1_Gain = h_ctl_roll_attitude_gain;
  roll_loop_P.D1_Gain = h_ctl_roll_rate_gain;

  // run the step
  roll_loop_step();

  // copy the outputs
  h_ctl_aileron_setpoint = (pprz_t) roll_loop_Y.cmd;
